...
EndFunc
Func _Cal_DelAll() _GUICtrlListView_DeleteAllItems($g_hLV_Cal) EndFunc
...
Func _Mach_Add()
    ...
    EndIf
EndFunc
Func _Mach_Edit() EndFunc
Func _Mach_Del() _GUICtrlListView_DeleteItem($g_hLV_Mach, _GUICtrlListView_GetSelectedIndices($g_hLV_Mach)) EndFunc
Func _Mach_DelAll() _GUICtrlListView_DeleteAllItems($g_hLV_Mach) EndFunc
...
EndFunc
Func _Ops_Edit() EndFunc
Func _Ops_Del() _GUICtrlListView_DeleteItem($g_hLV_Ops, _GUICtrlListView_GetSelectedIndices($g_hLV_Ops)) EndFunc
Func _Ops_DelAll() _GUICtrlListView_DeleteAllItems($g_hLV_Ops) EndFunc
...
EndFunc
Func _Rout_Edit() EndFunc
Func _Rout_Del() _GUICtrlListView_DeleteItem($g_hLV_Rout, _GUICtrlListView_GetSelectedIndices($g_hLV_Rout)) EndFunc
Func _Rout_DelAll() _GUICtrlListView_DeleteAllItems($g_hLV_Rout) EndFunc
...
EndFunc
Func _Mat_Edit() EndFunc
Func _Mat_Del() _GUICtrlListView_DeleteItem($g_hLV_Mat, _GUICtrlListView_GetSelectedIndices($g_hLV_Mat)) EndFunc
Func _Mat_DelAll() _GUICtrlListView_DeleteAllItems($g_hLV_Mat) EndFunc
...
EndFunc
Func _BOM_Edit() EndFunc
Func _BOM_Del() _GUICtrlListView_DeleteItem($g_hLV_BOM, _GUICtrlListView_GetSelectedIndices($g_hLV_BOM)) EndFunc
Func _BOM_DelAll() _GUICtrlListView_DeleteAllItems($g_hLV_BOM) EndFunc
...
EndFunc
Func _WO_Edit() EndFunc
Func _WO_Del() _GUICtrlListView_DeleteItem($g_hLV_WO, _GUICtrlListView_GetSelectedIndices($g_hLV_WO)) EndFunc
Func _WO_DelAll() _GUICtrlListView_DeleteAllItems($g_hLV_WO) EndFunc
...
EndFunc
Func _WOL_Edit() EndFunc
Func _WOL_Del() _GUICtrlListView_DeleteItem($g_hLV_WOL, _GUICtrlListView_GetSelectedIndices($g_hLV_WOL)) EndFunc
Func _WOL_DelAll() _GUICtrlListView_DeleteAllItems($g_hLV_WOL) EndFunc
...
EndFunc
Func _SR_Edit() EndFunc
Func _SR_Del() _GUICtrlListView_DeleteItem($g_hLV_SR, _GUICtrlListView_GetSelectedIndices($g_hLV_SR)) EndFunc
Func _SR_DelAll() _GUICtrlListView_DeleteAllItems($g_hLV_SR) EndFunc
...
EndFunc
Func _Cap_Edit() EndFunc
Func _Cap_Del() _GUICtrlListView_DeleteItem($g_hLV_Cap, _GUICtrlListView_GetSelectedIndices($g_hLV_Cap)) EndFunc
Func _Cap_DelAll() _GUICtrlListView_DeleteAllItems($g_hLV_Cap) EndFunc
...
EndFunc
Func _Stk_Edit() EndFunc
Func _Stk_Del() _GUICtrlListView_DeleteItem($g_hLV_Stk, _GUICtrlListView_GetSelectedIndices($g_hLV_Stk)) EndFunc
Func _Stk_DelAll() _GUICtrlListView_DeleteAllItems($g_hLV_Stk) EndFunc
